...
BASE_FOLDER = ''
TRAINING_FOLDER = 'user_data/training_files'
TEST_FOLDER   = 'user_data/test_files'
PUBLIC_LABELS = 'user_data/public_labels.csv'
TRAINING_FEATURE_FILENAME  = 'balabit_feature_extraction/output/balabit_features_training.csv'
TEST_FEATURE_FILENAME  = 'balabit_feature_extraction/output/balabit_features_test.csv'
...
ACTION_CSV_HEADER = "type_of_action,traveled_distance_pixel,elapsed_time,direction_of_movement,straightness,num_points,sum_of_angles,mean_curv,sd_curv,max_curv,min_curv," \
                    ...
                    "\n"
ACTION_FILENAME = 'balabit_feature_extraction/output/balabit_actions.csv'
